...
Route::middleware(['auth:sanctum', 'verified', 'XSS', 'permission:quote check'])->prefix('admin')->group(function () {
    ...
    Route::post('quote-section', [QuoteSectionController::class, 'store'])->name('quote-section.store');
    Route::put('quote-section/{id}', [QuoteSectionController::class, 'update'])->name('quote-section.update');
});
